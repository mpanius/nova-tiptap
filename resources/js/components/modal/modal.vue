    ...
    <div class="modal" v-if="show">
        <div class="modal-content">
            ...
            <header class="tab-header">
                <button type="button" @click="tab = 1;" :class="{ active: tab == 1 }">Link</button>
                <button type="button" @click="tab = 0;" :class="{ active: tab == 0 }">
                    Upload (Drag 'n' Drop)
                </button>
                <button type="button" @click="tab = 2;" :class="{ active: tab == 2 }">
                    Upload (Simple)
                </button>
            </header>
            ...
            <footer class="modal-footer">
                ...
                <button type="button"
                        @click="show = false;" class="danger">Close modal</button>
            </footer>
        </div>
    </div>
</template>
